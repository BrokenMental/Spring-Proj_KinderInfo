...
import us.inhatc.persistence.KinderDAO;
...
public class KinderService {
	...
	public JSONObject selectKinderList(SidoVO sidoVO) throws Exception {
		//302에러(페이지 이동 에러) http > https 수정
		String jsdata = "{\"kinderInfo\":[" + readJsonFromUrl(
				"https://e-childschoolinfo.moe.go.kr/api/notice/basicInfo.do?key=bbceda2aaffa42b39c1a8873211ca735&sidoCode="+sidoVO.getSidoCode()+"&sggCode="+sidoVO.getSigunguCode())+ "]}";
